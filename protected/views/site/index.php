...
$this->widget('bootstrap.widgets.TbBox', array(
	...
	'content' => '
		...
		qui dolorem eum fugiat, quo voluptas nulla pariatur? At vero eos et accusamus et iusto odio dignissimos ducimus, qui blanditiis praesentium voluptatum
		deleniti atque corrupti, quos dolores et quas molestias excepturi sint, obcaecati cupiditate non provident, similique sunt in culpa, qui officia deserunt
		...
		et aut officiis debitis aut rerum necessitatibus saepe eveniet, ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente
...
$this->widget('bootstrap.widgets.TbCarousel', array(
	'items' => array(
		array(
			'image' => '/css/Carousel/1.jpg',
			'label' => 'Yii 1',
			'itemOptions' => array('align' => 'middle'),
		),
		array(
			'image' => '/css/Carousel/2.png',
			'label' => 'Yii 2',
			'itemOptions' => array('align' => 'middle'),
		),
		array(
			'image' => '/css/Carousel/3.jpg',
			'label' => 'Yii 3',
			'itemOptions' => array('align' => 'middle'),
		),
		array(
			'image' => '/css/Carousel/4.jpg',
			'label' => 'Yii 4',
			'itemOptions' => array('align' => 'middle'),
		),
	),
